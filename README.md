...
For journeys beginning in Walvis Bay, the supplied per-person fares are N$150 to Swakopmund, N$150 to Arandis, N$270 to Usakos, N$270 to Karibib, N$150 to Okahandja and N$300 to Windhoek. Windhoek to Okahandja is N$150 per person and Windhoek to Usakos is N$270 per person. Arandis–Usakos is N$270 per person in both directions. The booking API owns this fare matrix and recalculates the total before reserving a seat. The corresponding Walvis Bay drop-off points are Swakopmund; Arandis service station; Shell Service Station in Usakos; Agra Service Station in Karibib; Wumpi Service Station / Shell Service Station in Okahandja; and home drop-off in Windhoek.
